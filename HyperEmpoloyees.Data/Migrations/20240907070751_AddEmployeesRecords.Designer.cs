...
namespace HyperEmpoloyees.Data.Migrations
{
    ...
    [Migration("20240907070751_AddEmployeesRecords")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.BookThanks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.Employees", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.EmployeesRecords", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.Roles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.SalaryRate", b =>
                {
                    ...
                    b.Property<float>("BounsYearRate")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.SystemRecords", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.BookThanks", b =>
                {
                    b.HasOne("HyperEmpoloyees.Core.Employees", "Employees")
                        .WithMany("BookThanks")
            ...
            modelBuilder.Entity("HyperEmpoloyees.Core.Roles", b =>
                {
                    b.HasOne("HyperEmpoloyees.Core.Users", "Users")
                        .WithMany("Roles")
