...
{
    public partial class EmpoloyeesUserControl : UserControl
    {
        private static EmpoloyeesUserControl? empoloyeesUserControl;
        private AddEmpoloyeesForm addEmpoloyeesForm;
        private static Main _main;
        private IDataHelper<Core.Employees> dataHelper;
        private List<Core.Employees> data;
        private List<int> IdDeleteList;

        public EmpoloyeesUserControl()
        {
            InitializeComponent();
        ...
        public static EmpoloyeesUserControl Instance(Main main)
        {
            _main = main;
            return empoloyeesUserControl ?? (empoloyeesUserControl = new EmpoloyeesUserControl());
        }

        #region Evints
        public void buttonAdd_Click(object sender, EventArgs e)
        {
            if (addEmpoloyeesForm == null || addEmpoloyeesForm.IsDisposed)
            {
                addEmpoloyeesForm = new AddEmpoloyeesForm(_main, 0, this);
                addEmpoloyeesForm.Show();
            }
            else
            {
                addEmpoloyeesForm.Focus();
            }
        ...
        private void Edit()
        {
            ...
            if (!dgvHelper.IsEmpty(dataGridView1))
            {
                ...
                if (addEmpoloyeesForm == null || addEmpoloyeesForm.IsDisposed)
                {
                    addEmpoloyeesForm = new AddEmpoloyeesForm(_main, Id, this);
                    addEmpoloyeesForm.Show();
                }
                else
                {
